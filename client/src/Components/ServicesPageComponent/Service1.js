          ...
          <div className="col-12 col-lg-6">
            <div className="row justify-content-xl-center">
              <div className="col-12 col-xl-10 align-items-lg-center">
                ...
                <p className="lead fs-4 mb-3 mb-xl-5 px-2 servicePara">{content}</p>
                <button type="button" className="btn bsb-btn-2xl btn-outline-success outlines rounded-pill">Know More</button>
              </div>
            </div>
          </div>
        ...
        <div className="container-fluid">
          <div className="row gy-md-4 gy-lg-0 ">
            ...
            <div className="col-12 col-lg-6">
              <div className="row justify-content-xl-center">
                <div className="col-12 col-xl-10 align-items-lg-center">
                  <h2 className="darkgreen h1 mb-3 mt-3">{title}</h2>
