...
function Agri_land_card_book(props) {
    const {ColdSt}=props;
    return ( <>
                ...
                <div className="row m-0 w-100 d-flex flex-column">
                  ...
                  <div className="col-12  midgreen">
                    ...
                    <div className="d-grid gap-2">
                      ...
                      <button type="bu tton" name="" id="" className="btn btn-outline-success btn-sm" ><i className=" bi-plus-circle"></i>&nbsp;Book</button>
                    </div>
                  </div>
                </div>
              </div>
...
export default Agri_land_card_book;