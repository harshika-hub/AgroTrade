                ...
                <form className="row g-3 needs-validation" id="dataForm" onSubmit={handelSubmit} noValidate>
                  <div className="col-12 columns mt-4">
                    ...
                    <div className="has-validation">
                      <input placeholder="Enter Email Address" type="email" className="form-control" onChange={validateEmail}  id="userSinginemail" aria-describedby="inputGroupPrepend" required
                      />
                  ...
                  <div className="col-12  columns ">
                    ...
                    <input placeholder="Enter Password" type="password" className="form-control" id="userSiginpassword" onChange={validatePassword} required/>
                    <div className="valid-feedback">
                       looks Good!!
                    </div>
                    <div className="invalid-feedback">
