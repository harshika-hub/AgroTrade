                ...
                <div className="card-body">
                  <div>
                    ...
                    <p className="card-text text-break darkgreen landpara mt-4 ">
                      Discover an exceptional land rental opportunity in the
                      heart of Indore, perfect for factory owners seeking
                      expansion or diversification into agricultural ventures.
                      This expansive 2.49-acre parcel of fertile land is now
                      available, offering a strategic location for those looking
                      to integrate farming into their industrial operations.
                    </p>
                  </div>
                </div>
              </div>
