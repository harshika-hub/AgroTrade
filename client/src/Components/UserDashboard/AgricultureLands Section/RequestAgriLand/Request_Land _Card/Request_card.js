...
import { declineRequest, acceptRequest } from "../../../../../store/userSlice.js"
    ...
    <div className="card bg-white overflow-hidden mt-2 p-0" >
      <div className="row m-0 w-100">
        ...
        <div className=" col-md-12 col-lg-3 p-3 ">
          {/* <h4 className="darkgreen" ><i class="fa-solid fa-wheat-awn"></i>&nbsp;Requested land: {request.land.address}</h4> */}
          <h5 className="darkgreen text-start" ><i class="bi bi-geo-fill"></i>&nbsp;Requested Land address: {request.land.address}</h5>

          <h5 className="darkgreen" ><i class="fa-solid fa-wheat-awn"></i>&nbsp;Requested grain: {request._doc.grainName}</h5>
          <h5 className="darkgreen" ><i class="fa-solid fa-weight-scale"></i>&nbsp;Requested Quantity: {request._doc.quantity} Quiantle</h5>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body>
          ...
          <div class="input-group mb-3">
            ...
            <input onChange={(e) => { setPrice(e.target.value) }} type="number" class="form-control" min={1000} placeholder="Enter price here" />
          </div>
