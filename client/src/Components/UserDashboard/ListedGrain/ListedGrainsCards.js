          ...
          <div className=" col-12 col-sm-6 col-md-12 col-lg-12 col-xl-6 ">
            <div className="card-body">
              ...
              <div className="d-grid gap-2">
                <button type="bu tton" name="" id="" className="btn btn-outline-success btn-sm"><i className="bi bi-arrow-up-circle"></i>&nbsp;Update
                </button>
                <button type="bu tton" name="" id="" className="btn btn-outline-danger btn-sm"><i className="bi bi-trash"></i>&nbsp;Delete
                </button>
              </div>
            </div>
          </div>
