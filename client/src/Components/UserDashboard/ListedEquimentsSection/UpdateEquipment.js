                        ...
                        <div className="col-12 col-lg-7 col-md-12  p-3" id="equipmentcol" >
                            ...
                            >
                                ...
                                <div className="col-12 col-md-6 p-1">
                                    ...
                                    <select name="state" defaultValue={Equipment.state} onChange={(event)=>{checkField(event);handleChange(event)}} id="state" className="form-control form-control-sm">
                                ...
                                <div className="col-12 col-md-6 p-1">
                                    ...
                                    <select name="city" defaultValue={Equipment.city} onChange={(event)=>{checkField(event);handleChange(event)}} id="city" className="form-control form-control-sm">
