...
import { farmerSignedAgreementCd } from '../../../../../store/userSlice.js';
            ...
            <div className='row w-100 m-0' >
              ...
              <div className='col-12' >
                ...
                <ol className='darkgreen'>
                  ...
                  <li> The total price <b> Rs.{contract._doc.price} </b>for the land usage and crop production services shall be calculated based on the agreed-upon rent and grain fee, as specified in Sections 2.1 and 2.2 of this agreement.</li>
