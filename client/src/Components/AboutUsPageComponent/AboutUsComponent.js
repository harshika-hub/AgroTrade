...
import aboutlast from '../../Images/aboutlast.jpeg'
import about1 from '../../Images/aboutimag1.jpg'
      ...
      <div className="container pt-4 mb-4 ">
        <div className="row ">
          <div id='ourteam' className="col-lg-6 ml-auto p-4 ">
            ...
            <h3 className="heading1 ">Our Team</h3>
             <p style={{textAlign:"justify"}}>OriFarm is a fresh and modern Elementor Template Kit that ideal to create a website for all kinds of Farming, Agriculture, Organic
                        ...
                        <div className="row">
                           <div className="col-lg-5 ml-auto ">
                            ...
                            <div className="col-lg-6  mb-lg-0 ">
                                <img src={aboutlast} alt="logo" id="aboutImg" className="img-fluid img-overlap" />
                            </div>
