  ...
  return (
    ...
    <div className="col-md-6 col-lg-5 col-xl-4 p-0  d-flex flex-column  parent  "  >
     ...
     <div className="col-md-6 col-lg-7 col-xl-8  h-100 p-0 ">
       <div className="card p-0 m-0 box-shadow ps-3 bg-light">
       ...
       <div className=" overflow-scroll">
        ...
        <div className="w-100  row m-0"  >
          <div className="col-9 p-1">
            <input type="text" class="form-control-lg w-100 " id="floatingInput" placeholder="Type a message..."/>
         </div>
         <div className="col-1 p-1">
          ...
          <form className=""  id="uploadprofileimage" action="/user/uploadprofileimage" method="post" enctype="multipart/form-data">
           <input type="file" id="fileInput" name="profileimage" style={{display:"none"}} onchange="submitFormOnChange()"  accept="image/*"/>
            <label for="imageInput" class="custom-file-input-label" id="fileInputLabel"><i class="bi bi-paperclip"></i></label>
           </form>
          </button>
       </div>
         <div className="col-2 p-1">
           <button type="button" className="btn btn-outline-primary w-100 h-100 "><i class="bi bi-send-fill"></i>&nbsp;Send</button>
         </div>
        </div>
        </div>
